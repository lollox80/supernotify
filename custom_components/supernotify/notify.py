...
async def async_get_service(
    ...
    service = SupernotifyAction(
        ...
        media_path_share=config[CONF_MEDIA_PATH_SHARE],
    ...
    def supplemental_action_enquire_configuration(_call: ServiceCall) -> dict[str, Any]:
        return {
            ...
            CONF_MEDIA_PATH_SHARE: config.get(CONF_MEDIA_PATH_SHARE, None),
...
class SupernotifyAction(BaseNotificationService):
    ...
    def __init__(
        ...
        media_path_share: str | None = None,
        ...
        self.context = Context(
            ...
            MediaStorage(
                media_path,
                media_path_share=media_path_share,
